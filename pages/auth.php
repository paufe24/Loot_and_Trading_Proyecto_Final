...
<head>
    ...
    <style>
        ...
        body.dark .auth-container { background: #080c1a; }
        ...
        .form-card {
            background: var(--bg-surface-elevated, rgba(255,255,255,0.72));
        ...
        .form-card h2 {
            ...
            margin-bottom: 30px;
            text-align: center;
            background: var(--gradient-brand, linear-gradient(135deg, #3b82f6 0%, #06b6d4 50%, #8b5cf6 100%));
        ...
        .form-card input {
            width: 100%;
            padding: 15px 20px;
            border: 1.5px solid var(--border-color, rgba(148,163,184,0.18));
        ...
        .form-card button:hover {
            ...
            box-shadow: 0 10px 30px rgba(59,130,246,0.35), 0 0 20px rgba(59,130,246,0.15);
            background: #2563eb;
        }

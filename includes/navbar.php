<?php
// includes/navbar.php — nav compartida. Requiere session_start() previo en el archivo que la incluye.
$_nav_logged_in = isset($_SESSION['user_id']);
require_once dirname(__DIR__) . '/includes/csrf.php';
?>
<meta name="csrf-token" content="<?php echo htmlspecialchars(csrf_token()); ?>"><?php // CSRF token para fetch() ?>
<nav class="nav-dock">
    ...
    <div class="nav-logos-center">
        ...
        <a href="mercado.php?game=magic"    class="nav-item" title="Magic">    <img src="../img/magic.png"    alt="Magic"     class="nav-logo"></a>
    ...
    <a href="apuestas.php" class="nav-item" title="Subastas" style="color:#f97316;">
...
<button class="nav-item dark-toggle" onclick="toggleDarkMode()" title="Cambiar tema">
    ...
    <?php if ($_nav_logged_in): ?>
        <a href="amigos.php" class="nav-item" title="Amigos">
        ...
        <a href="mis-cartas.php" class="nav-item" title="Mis Cartas">
        ...
        <a href="profile.php" class="nav-item user-active" title="Mi Perfil">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"/></svg>
            Perfil
        </a>
        <a href="logout.php" class="nav-item logout-btn" title="Cerrar Sesión">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"/></svg>
        </a>
    <?php else: ?>

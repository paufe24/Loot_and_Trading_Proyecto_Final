...
<style>
.nav-dock { position:fixed;top:0;left:0;width:100%;height:64px;background:rgba(255,255,255,0.6);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);padding:0 24px;box-shadow:0 1px 0 rgba(255,255,255,0.25),0 1px 3px rgba(0,0,0,0.04);border-bottom:1px solid rgba(148,163,184,0.18);display:flex;align-items:center;gap:8px;z-index:1000;box-sizing:border-box;transition:background .3s,border-color .3s; }
body.dark .nav-dock { background:rgba(17,24,39,0.75);border-color:rgba(51,65,85,0.35); }
.nav-dock .spacer { flex:1; }
.nav-item { display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 12px;border-radius:12px;cursor:pointer;text-decoration:none;color:#5b6478;font-size:.9rem;transition:all .3s cubic-bezier(.25,.46,.45,.94);border:none;background:none;font-family:'Outfit',sans-serif; }
.nav-item:hover { background:rgba(59,130,246,0.06);color:#3b82f6;transform:translateY(-1px); }
body.dark .nav-item:hover { background:rgba(96,165,250,0.08);color:#93c5fd; }
...
/* Pill Subastas */
.nav-pill { background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.15);border-radius:50px;padding:8px 18px;font-weight:700;font-size:.85rem;color:#3b82f6; }
.nav-pill:hover { background:#3b82f6;color:#fff;border-color:transparent;box-shadow:0 4px 20px rgba(59,130,246,.35),0 0 20px rgba(59,130,246,0.15);transform:translateY(-2px); }
body.dark .nav-pill { background:rgba(96,165,250,0.1);border-color:rgba(96,165,250,0.2);color:#93c5fd; }

/* Botón usuario */
.nav-user-btn { display:inline-flex;align-items:center;gap:8px;padding:8px 16px;border-radius:50px;background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.12);cursor:pointer;font-weight:700;font-size:.85rem;color:#0c1222;font-family:'Outfit',sans-serif;transition:all .3s cubic-bezier(.25,.46,.45,.94); }
.nav-user-btn:hover, .nav-user-btn.active { background:#3b82f6;color:#fff;border-color:transparent;box-shadow:0 4px 20px rgba(59,130,246,.35),0 0 20px rgba(59,130,246,0.15); }
body.dark .nav-user-btn { background:rgba(96,165,250,0.1);border-color:rgba(96,165,250,0.18);color:#e2e8f0; }
...
.nav-dd.open { display:flex;animation:ddSlide .2s cubic-bezier(.34,1.56,.64,1); }
@keyframes ddSlide{from{opacity:0;transform:translateY(-8px) scale(.96)}to{opacity:1;transform:translateY(0) scale(1)}}
body.dark .nav-dd { background:rgba(17,24,39,0.85);border-color:rgba(51,65,85,0.35);box-shadow:0 16px 50px rgba(0,0,0,.5); }
.nav-dd a {
    display:flex;
    align-items:center;
    gap:10px;
...
.nav-dd a:hover { background:rgba(59,130,246,0.06);color:#3b82f6; }
body.dark .nav-dd a:hover { background:rgba(96,165,250,0.08);color:#93c5fd; }
